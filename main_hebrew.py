...
bookDictionary = {1:("br_edit.txt", "בראשית"), 2:("sh_edit.txt", "שמות"), 3:("vy_edit.txt", "ויקרא"), 4:("bm_edit.txt", "במדבר"), 5:("dv_edit.txt", "דברים"), 6:("neviim/yehoshua_edit.txt", "יהושע"), 7:("neviim/shoftim_edit.txt", "שופטים"), 8:("neviim/shmuel1_edit.txt", "שמואל א"), 9:("neviim/shmuel2_edit.txt", "שמואל ב"), 10:("neviim/melachim1_edit.txt", "מלכים א"), 11:("neviim/melachim2_edit.txt", "מלכים ב"), 12:("neviim/yeshaya_edit.txt", "ישעיה"), 13:("neviim/yirmiya_edit.txt", "ירמיה"), 14:("neviim/yechezkel_edit.txt", "יחזקאל"), 15:("neviim/hoshea_edit.txt", "הושע"), 16:("neviim/yoel_edit.txt", "יואל"), 17:("neviim/amos_edit.txt", "עמוס"), 18:("neviim/ovadya_edit.txt", "עובדיה"), 19:("neviim/yonah_edit.txt", "יונה"), 20:("neviim/micha_edit.txt", "מיכה"), 21:("neviim/nachum_edit.txt", "נחום"), 22:("neviim/chavakuk_edit.txt", "חבקוק"), 23:("neviim/tzefania_edit.txt", "צפניה"), 24:("neviim/chagai_edit.txt", "חגי"), 25:("neviim/zecharia_edit.txt", "זכריה"), 26:("neviim/malachi_edit.txt", "מלאכי"), 27:("kesuvim/tehilim_edit.txt", "תהלים"), 28:("kesuvim/mishlei_edit.txt", "משלי"), 29:("kesuvim/iyov_edit.txt", "איוב"), 30:("kesuvim/shirHashirim_edit.txt", "שיר השירים"), 31:("kesuvim/rus_edit.txt", "רות"), 32:("kesuvim/eicha_edit.txt", "איכה"), 33:("kesuvim/koheles_edit.txt", "קהלת"), 34:("kesuvim/esther_edit.txt", "אסתר"), 35:("kesuvim/daniel_edit.txt", "דניאל"), 36:("kesuvim/ezra_edit.txt", "עזרא"), 37:("kesuvim/nechemia_edit.txt", "נחמיה"), 38:("kesuvim/divreiHayamim1_edit.txt", "דברי הימים א"), 39:("kesuvim/divreiHayamim2_edit.txt", "דברי הימים ב")}
